            ...
            <div className="container mx-auto px-4 flex flex-col lg:items-center justify-between lg:flex-row">
              <div className="mb-14 xl:mb-0">
                <h1 className="text-2xl leading-tight md:text-4xl xl:text-5xl font-semibold leading-10   text-gray-800 xl:w-2/3 pr-16 lg:pr-0">
                  Our customers love what we provide
                </h1>
                <p className="mt-4 text-base leading-normal text-gray-600 md:w-2/3 lg:w-3/4 pr-16 lg:pr-0">
                  Over 500 customers use big basket to shop their groceries and
              ...
              >
                  ...
                  <div className="pl-4 pt-4 flex items-start justify-between">
                    <div className="mr-6">
                      <p className="xl:text-xl xl:leading-loose text-gray-600">
                        I just received my first delivery from BigBasket on
                        Monday. Here is an acknowledgment note of complete
                        satisfaction and infact happiness. I am very satisfied
                        with your service and really appreciate your work.
                      </p>
                ...
                >
                  <div className="pl-4 pt-4 flex items-start justify-between">
                    <div className="mr-6">
                      <p className="xl:text-xl xl:leading-loose text-gray-600">
                        I was looking to shop without having to travel and the
                        need to carry; to shop from home when my kids are
                        sleeping; also to avoid compulsive buying (typically the
                        tendency is to buy unplanned stuff whenever something is
                        new)
                      </p>
                      <p className="mt-4 text-base font-semibold leading-none text-gray-800">
                        Dany John
