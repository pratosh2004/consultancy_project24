    ...
    return (
        <>
            <React.Fragment>
                ...
                >
                    <ListItemIcon>
                        <WidgetsIcon sx={{ color: (location.pathname === "/" || location.pathname === "/Seller/dashboard") ? '#7f56da' : 'inherit' }} />
                    </ListItemIcon>
                ...
                >
                    <ListItemIcon>
                        <PendingActionsIcon sx={{ color: location.pathname.startsWith("/Seller/orders") ? '#7f56da' : 'inherit' }} />
                    </ListItemIcon>
                ...
                </ListItemButton>
                {
                    ...
                    >
                        <ListItemIcon>
                            <AdminPanelSettingsIcon sx={{ color: location.pathname.startsWith("/Seller/shopcart") ? '#7f56da' : 'inherit' }} />
                        </ListItemIcon>
            ...
            <React.Fragment>
                ...
                >
                    <ListItemIcon>
                        <AccountCircleIcon sx={{ color: location.pathname.startsWith("/Seller/profile") ? '#7f56da' : 'inherit' }} />
                    </ListItemIcon>
                ...
                >
                    <ListItemIcon>
                        <LogoutIcon sx={{ color: location.pathname.startsWith("/logout") ? '#7f56da' : 'inherit' }} />
                    </ListItemIcon>
